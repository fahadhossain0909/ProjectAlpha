...
def main() -> int:
    ...
    parser.add_argument("--once", action="store_true", help="process available experiences once")
    parser.add_argument("--poll-seconds", type=int, default=int(os.getenv("LEARNING_POLL_SECONDS", "60")))
    parser.add_argument("--lookback-hours", type=int, default=int(os.getenv("LEARNING_LOOKBACK_HOURS", "168")))
    ...
    worker = ContinualLearningWorker(
        ...
        state_path=os.getenv("LEARNING_STATE_PATH", "models/online_rl/worker_state.json"),
