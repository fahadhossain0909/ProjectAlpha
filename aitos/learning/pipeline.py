...
class ContinualLearningPipeline:
    ...
    def __init__(self, registry: ModelRegistry, evolution: EvolutionEngine,
    ...
    def evaluate_proposal(
        ...
        validation = self.validator.evaluate(
            events, strategy, mark_price, champion_result,
            initial_cash, fee_rate, slippage_bps,
        )
        ...
        if validation.passed and version:
            ...
            artifact = self.registry.register(ModelArtifact(
