...
class LearningExperienceRecorder(AITOSModule):
    ...
    async def _on_decision(self, event: Event) -> Optional[EventResponse]:
        ...
        record = ExperienceRecord(
            ...
            market_state={"regime": p.get("regime"), "kernel_direction": p.get("kernel_direction"), "kernel_confidence": p.get("kernel_confidence")},
            ...
            metadata={"decision_id": str(p.get("decision_id") or event.event_id), "event_type": "decision"},
        )
