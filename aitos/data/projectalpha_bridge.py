"""Bridge canonical historical events into ProjectAlpha's existing domain models."""
...
def canonical_trade_to_domain(event: CanonicalTrade) -> TradeTick:
    ...
    try:
        ...
        # The domain model currently requires an integer trade id. Preserve
        # deterministic identity for non-numeric exchange ids rather than
