...
class TradeLifecycle(AITOSModule):
    def __init__(self, event_bus: EventBus, risk_engine: RiskEngine, order_executor: Optional[OrderExecutor] = None, kernel: Optional[AIKernel] = None, use_exchange_side_stops: bool = False) -> None:
