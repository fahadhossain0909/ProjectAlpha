...
def test_partitioned_zstd_writer(tmp_path):
    events = [
        CanonicalTrade("binance", "futures_um", "BTCUSDT", "1", datetime(2024, 1, 2, tzinfo=timezone.utc), 42000.0, 0.1, "buy"),
        CanonicalTrade("binance", "futures_um", "BTCUSDT", "2", datetime(2024, 1, 2, 0, 0, 1, tzinfo=timezone.utc), 42001.0, 0.2, "sell"),
    ]
