...
def test_policy_monitor_recommends_rollback_after_degradation():
    ...
    result = evaluate_policy_health("v2", outcomes, baseline_avg_r=0.5, min_observations=30, max_degradation=0.20)
...
def test_policy_monitor_waits_for_sample_size():
    result = evaluate_policy_health("v2", [{"r_multiple": -1.0}], baseline_avg_r=0.5, min_observations=30)
